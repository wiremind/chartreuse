...
def test_chartreuse_upgrade_detected_migration_enabled_stop_pods(
    ...
    mocked_stop_pods = mocker.patch("chartreuse.kubernetes_helper.KubernetesDeploymentManager.stop_pods")
    mocker.patch("chartreuse.kubernetes_helper.KubernetesDeploymentManager.start_pods")
